export const questions = [
    {
        ...
        answer: 'ניתן להחליף כל מתג בבית למתג חכם.' +
            ...
            'מתג כח מאפשר לחבר את כל ״צרכני החשמל הכבדים״: מזגנים, דוד חשמלי, ואפילו מכונת כביסה או את המייבש.' +
            'מתג שלט רחוק/שלט רחוק חכם- מאפשר לכם להקליט את השלטים של מכשירי החשמל לתוך מערכת הבית החכם כך שתוכלו לשלוט בהם מרחוק ואף לערוך תסריטים הכוללים את הפעלה של המכשירים. \n' +
        ...
        answer: 'את הבית החכם ניתן להתקין גם בדירות ישנות ואפילו בדירות שכורות: ניתן להעביר את המערכת איתכם בעת מעבר בפירוק והתקנה פשוטים על ידי צוות המתקינים שלנו.'
    }, {
        ...
        answer: 'בוודאי! באמצעות חיבור הדוד ל״מתג כח״.' +
            'חיבור הדוד למערכת הבית החכם תאפשר לכם לשלוט על הדוד באמצעות האפליצקיה,' +
